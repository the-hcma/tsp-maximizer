...
Resolve `OWNER/NAME` from `git remote get-url origin`. When not in repository-helpers,
use `${REPOSITORY_HELPERS_DIR:-$HOME/work/ai/repository-helpers}/scripts/github-repo-lint`.
